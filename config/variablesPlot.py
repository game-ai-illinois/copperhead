...
#variables.append(Variable("dimuon_pt_zpt_wgt_off", r"$p_{T}(\mu\mu)$ [GeV]", 30, 0, 300))
...
variables.append(Variable("mu1_bsConstrainedChi2", r"$\chi^{2}(\mu_{1}))$", 50, 0, 200))
variables.append(
...
variables.append(Variable("mu2_pt", r"$p_{T}(\mu_{2})$ [GeV]", 70, 0, 150))
variables.append(Variable("mu2_pt_raw", r"$p_{T}(\mu_{12})$ [GeV]", 50, 0, 300)) # DO NOT CHANGE LOWER BOUNDARY
variables.append(Variable("mu2_bsConstrainedPt", r"$p_{T}(\mu_{2})$ [GeV]", 50, 0, 120))
variables.append(Variable("mu2_bsConstrainedChi2", r"$\chi^{2}(\mu_{2}))$", 50, 0, 120))
variables.append(
...
variables.append(Variable("jet1_pt", r"$p_{T}(jet1)$ [GeV]", 50, 25, 250))
variables.append(Variable("jet1_eta", r"$\eta (jet1)$", 40, -4.7, 4.7))
variables.append(Variable("jet1_phi", r"$\phi (jet1)$", 50, -3.2, 3.2))
variables.append(Variable("jet1_qgl", r"$QGL (jet1)$", 50, 0, 1))
variables.append(Variable("jet1_id", "jet1 ID", 9, 0, 8))
variables.append(Variable("jet1_puid", "jet1 PUID", 9, 0, 8))
...
variables.append(Variable("jet2_pt", r"$p_{T}(jet2)$ [GeV]", 50, 25, 150))
variables.append(Variable("jet2_eta", r"$\eta (jet2)$", 40, -4.7, 4.7))
variables.append(Variable("jet2_phi", r"$\phi (jet2)$", 50, -3.2, 3.2))
variables.append(Variable("jet2_qgl", r"$QGL (jet2)$", 50, 0, 1))
variables.append(Variable("jet2_id", "jet2 ID", 9, 0, 8))
variables.append(Variable("jet2_puid", "jet2 PUID", 9, 0, 8))
...
variables.append(Variable("jj_dEta", r"$\Delta\eta (jj)$", 50, 0, 9))
variables.append(Variable("jj_dPhi", r"$\Delta\phi (jj)$", 50, 0, 3.2))
